              ...
              <Grid className={classes.paper} container>
                ...
                <Grid item xl={true} lg={true} md={true} sm={true} xs={true}>
                  ...
                  <Typography className={classes.description}>
                    Банк дает вам сумму до 3 000 000 тенге, Вы решаете как
                    оплачивать покупки: одним платежом или в рассрочку
                  </Typography>
                </Grid>
              </Grid>
            </Grid>
                ...
                <Grid item xl={true} lg={true} md={true} sm={true} xs={true}>
                  ...
                  <Typography className={classes.description}>
                    <ul list-style-type="circle" className={classes.leftSide}>
                      <li>
                        1% с любой личной покупки картой
              ...
              <Grid className={classes.paper} container>
                ...
                <Grid item xl={true} lg={true} md={true} sm={true} xs={true}>
                  ...
                  <Typography className={classes.description}>
                    <ul list-style-type="circle" className={classes.leftSide}>
                      <li>
                        Тратьте и возвращайте деньги, выданные Банком, без
                        процентов до 55 дней
                      </li>
                      <li>
                        Покупайте у наших
                        <a
                          href="#s"
                          onClick={() => eventGAPartners()}
                ...
                <Grid item xl={true} lg={true} md={true} sm={true} xs={true}>
                  ...
                  <Typography className={classes.description}>
                    <ul list-style-type="circle" className={classes.leftSide}>
                      ...
                      <li>
                        Снятие личных средств до 3 000 000 т в мес. в любом
                        банкомате РК
                      </li>
                    </ul>
                  </Typography>
