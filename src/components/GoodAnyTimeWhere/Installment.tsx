            ...
            <Grid container className={classes.noteBlock}>
              ...
              >
                {isShowNote ? (
                  ...
                  <div
                    onClick={() => eventGAUncover()}
                    className={classes.noteShow}
                  >
              ...
              <Grid container>
                <Grid item xl={7} lg={7} md={7} sm={12} xs={12}>
                  ...
                  <Typography className={classes.noteDetail}>
                    ...
                    <a
                      href="#s"
                      onClick={() => eventGAPartnersModeInstall()}
                      className={classes.purple}
                    >
                      {" "}
                      партнеров
                  ...
                  <Grid item>
                    <Button
                      onClick={() => eventGAButtonFirstPurchase()}
                      className={classes.tabButtonFirstPurchaise}
                    >
                      Оформить рассрочку
                    </Button>
                  </Grid>
          ...
          >
            <Grid container direction="row" alignItems="center">
              <Grid item>
                ...
                <span className={classes.note}>
                  Вне сети партнеров с комиссией 1% на 3 месяца
                </span>
              </Grid>
            </Grid>
          </Grid>
