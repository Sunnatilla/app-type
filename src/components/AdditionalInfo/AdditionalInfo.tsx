...
const Tarifs = () => {
  ...
  const rows = [
    ...
    },
    {
      ...
      value:
        "бесплатно - личные средства до 3 000 000 т в мес. в любом банкомате РК"
    }
  ];
  return (
    <Box width={0.7}>
...
const Questions = () => {
  ...
  const rows = [
    ...
    {
      code: "Я получу приветсвенный бонус?",
      value: (
        <div className={classes.noteShow}>
          {" "}
          <ArrowDropDown className={classes.noteIcons} />
    ...
    {
      code: "Как заработать с #картакарта?",
      value: (
        <div className={classes.noteShow}>
          {" "}
          <ArrowDropDown className={classes.noteIcons} />
    ...
    {
      code: "Как выбирать любимые категории с повышенным кешбэком?",
      value: (
        <div className={classes.noteShow}>
          {" "}
          <ArrowDropDown className={classes.noteIcons} />
    ...
    {
      code: "Могу ли я расплачиваться картой за границей?",
      value: (
        <div className={classes.noteShow}>
          {" "}
          <ArrowDropDown className={classes.noteIcons} />
    ...
    {
      code: "Зачем мне нужен кредитный лимит по #картакарта?",
      value: (
        <div className={classes.noteShow}>
          {" "}
          <ArrowDropDown className={classes.noteIcons} />
    ...
    {
      code: "Как я узнаю, что мне установили кредитный лимит?",
      value: (
        <div className={classes.noteShow}>
          {" "}
          <ArrowDropDown className={classes.noteIcons} />
    ...
    {
      code: "Что такое рассрочка по #картакарта?",
      value: (
        <div className={classes.noteShow}>
          {" "}
          <ArrowDropDown className={classes.noteIcons} />
    ...
    {
      code: "Как включить режим рассрочки по #картакарта?",
      value: (
        <div className={classes.noteShow}>
          {" "}
          <ArrowDropDown className={classes.noteIcons} />
    ...
    {
      code: "Какие сроки рассрочки предусмотрены  по #картакарта?",
      value: (
        <div className={classes.noteShow}>
          {" "}
          <ArrowDropDown className={classes.noteIcons} />
    ...
    {
      code: "Есть ли комиисия за рассрочку?",
      value: (
        <div className={classes.noteShow}>
          {" "}
          <ArrowDropDown className={classes.noteIcons} />
    ...
    {
      code: "Я могу покапуть в рассрочку за счет личных денег?",
      value: (
        <div className={classes.noteShow}>
          {" "}
          <ArrowDropDown className={classes.noteIcons} />
    ...
    {
      code: "Я могу погашать задолженность по карте досрочно?",
      value: (
        <div className={classes.noteShow}>
          {" "}
          <ArrowDropDown className={classes.noteIcons} />
    ...
    {
      code: "Я нерезидент, я могу получить кредитный лимит по карте?",
      value: (
        <div className={classes.noteShow}>
          {" "}
          <ArrowDropDown className={classes.noteIcons} />
...
const Documents = () => {
  ...
  const rows = [
    {
      code: <img src="pdf.png" alt="star_mobile_banking" />,
      value: (
        <a className={classes.ref} href="./Кешбэк программа.pdf.pdf">
          Кешбэк программа.pdf
        </a>
      )
    },
    {
      code: <img src="pdf.png" alt="star_mobile_banking" />,
      value: (
        <a className={classes.ref} href="./Программа рассрочки.pdf.pdf">
          Программа рассрочки.pdf
        </a>
      )
    }
    // {code: <img src="pdf.png" alt="star_mobile_banking" />, value: <object><embed src="./Программа рассрочки.pdf.pdf" /></object>},
  ];
    ...
    <Box width={0.7}>
      <Table>
        <TableBody>
          {rows.map((m, i) => (
            <TableRow key={i}>
              <TableCell style={{ width: "10px" }}>{m.code}</TableCell>
              <TableCell className={classes.td}>{m.value}</TableCell>
            </TableRow>
          ))}
        </TableBody>
    ...
    <Grid container className={classes.root}>
      ...
      <Grid item xl={12} lg={12} md={12} sm={12} xs={12}>
        <Tab
          ...
          pans={[<Conditions />, <Tarifs />, <Questions />, <Documents />]}
        />
      </Grid>
    </Grid>
  );
