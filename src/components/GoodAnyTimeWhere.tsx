...
import { Grid, Button, RootRef, Typography, Table, TableBody, TableRow, TableCell } from '@material-ui/core';
...
const GoodAnyTimeWhere = (props: any) => {
    ...
    const eventGAPartnersModeInstall = () => {
        ReactGA.event({
            category: '#CardCard',
    ...
    const eventGAButtonFirstPurchase = () => {
        ReactGA.event({
            category: '#CardCard',
            ...
            <Grid container className={classes.root} spacing={2}>
                ...
                <Grid item xl={12} lg={12} md={12} sm={12} xs={12} className={classes.tabButtonsBlock}>
                    <Grid container spacing={2}>
                        <Grid item>
                            <Button onClick={() => eventGASmartFreeLoan()} variant="contained" className={classes.tabButtonActive}>Умная рассрочка</Button>
                        </Grid>
                        <Grid item>
                            <Button onClick={() => eventGACreditCard()} variant="contained" className={classes.tabButton}>Кредитная карта</Button>
                        </Grid>
                    </Grid>
                </Grid>
                <Grid item xl={12} lg={12} md={12} sm={12} xs={12} className={classes.tabButtonsBlock}>
                    <Typography className={classes.subTitle}>Умная рассрочка до 12 месяцев</Typography>
                    <Typography className={classes.subTitleDesc}>Управление в
                    <a href='#s' onClick={() => eventGAStarBanking()} className={classes.purple}> StarBanking </a>
                        24/7</Typography>
                </Grid>
                            ...
                            <Grid container className={classes.noteBlock}>
                                <Grid item xl={9} lg={9} md={9} sm={9} xs={12}>
                                    <Grid container direction="row">
                                        ...
                                        <Grid item sm={true} xs={true}>
                                            <span className={classes.note}>Активируйте режим рассрочки в StarBanking и покупайте в рассрочку</span>
                                        </Grid>
                                    </Grid>
                                </Grid>
                                <Grid item xl={3} lg={3} md={3} sm={3} xs={12} className={classes.note}>
                                    {isShowNote
                                        ...
                                        :
                                        <div onClick={() => eventGAUncover()} className={classes.noteShow}>Расскрыть <ArrowDropDown className={classes.noteIcons} /></div>
                                    }
                                </Grid>
                            </Grid>
                        </Grid>
                            ...
                            <Grid item xl={12} lg={12} md={12} sm={12} xs={12} className={classes.noteDetailBlock}>
                                <Grid container>
                                    <Grid item xl={7} lg={7} md={7} sm={12} xs={12}>
                                        ...
                                        <Typography className={classes.noteDetail}>4. С включенным режимом рассрочки все ваши покупки по #картекарте от 5 000 т за счет кредитного лимита будут делиться на равные части без комиссий в сети
                                    <a href='#s' onClick={() => eventGAPartnersModeInstall()} className={classes.purple}> партнеров</a>.
                                    </Typography>
                                    <Grid item>
                                            <Button onClick={() => eventGAButtonFirstPurchase()} className={classes.tabButtonFirstPurchaise}>Сделать первую покупку</Button>
                                        </Grid>
                                    </Grid>
                                    <Grid item xl={5} lg={5} md={5} sm={12} xs={12}>
                                        <Grid container justify="center">
                                            <img className={classes.img} src="final_ver_animation.gif" alt="star_mobile_banking" />
                                        </Grid>
                        ...
                        <Grid item xl={12} lg={12} md={12} sm={12} xs={12} className={classes.noteBlock}>
                            <Grid container direction="row" alignItems="center">
                                <Grid item>
                                    ...
                                    <span className={classes.note}>Вне сети партнеров с комиссией 1% на 3 месяца</span>
                                </Grid>
                            </Grid>
                        </Grid>
                    </Grid>
